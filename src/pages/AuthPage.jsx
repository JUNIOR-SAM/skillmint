...
export default function AuthPage() {
  ...
  const friendlyError = (code) => {
    const map = {
      ...
      'auth/password-does-not-meet-requirements': 'Password must have at least 1 uppercase letter, 1 number and 1 special character (e.g. J0hn@123)',
          ...
          <div key={contentKey} className="auth-content">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <Field
                ...
                placeholder={isLogin ? 'Your password' : 'e.g. Samuel@123'}
